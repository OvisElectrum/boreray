  ...
  setup do
    list = [
      new_resource(
        ...
        1,
        10.01,
        DateTime.new!(~D[2016-05-24], ~T[13:26:08.000], "Etc/UTC"),
        Decimal.from_float(10.01)
      ),
      new_resource(
        false,
        "resource2",
        2,
        20.01,
        DateTime.new!(~D[2016-06-24], ~T[13:26:08.000], "Etc/UTC"),
        Decimal.from_float(20.01)
      ),
      new_resource(
        true,
        "resource3",
        3,
        30.01,
        DateTime.new!(~D[2016-07-24], ~T[13:26:08.000], "Etc/UTC"),
        Decimal.from_float(30.01)
      )
    ]
